...
const Login = () => {
    ...
    const [role, setRole] = useState('user'); // State to manage role selection
    const navigate = useNavigate();

    const handleLogin = (e) => {
        e.preventDefault();
        // Replace with your actual login logic
        if (email === "user@gmail.com" && password === "user" && role === "user") {
            navigate('/user/dashboard');
        } else if (email === "admin@gmail.com" && password === "admin" && role === "admin") {
            navigate('/admin/dashboard');
        } else if (email === "tutor@gmail.com" && password === "tutor" && role === "tutor") {
