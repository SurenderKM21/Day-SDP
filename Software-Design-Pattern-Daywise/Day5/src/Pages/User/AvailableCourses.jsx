...
const AvailableCourses = () => {
  ...
  const [userId, setUserId] = useState(''); // Assuming userId will be set somewhere in the component or fetched
  ...
  const handleEnrollClick = async (course_id) => {
    try {
      ...
      await handleEnrollment(course_id, user_id); // Pass userId and courseId here
