...
const addcourse = (title, duration, category, difficultyLevel, syllabus, schedule, prerequisites) => {
...
export { axiosInstance, getUsers, SignUp, login,getusercourse ,addcourse,getCourses,deleteCourse,handleEnrollment };
